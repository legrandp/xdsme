...
TEMPLATE += """
 ...
 DETECTOR= %(DETECTOR)s   MINIMUM_VALID_PIXEL_VALUE= 1   OVERLOAD= 65000
 ...
 MINIMUM_NUMBER_OF_PIXELS_IN_A_SPOT= 9
 STRONG_PIXEL= 8.0
...
'BACKGROUND_RANGE':(['imageRanges'], lambda x: [x[0][0],min(x[0][0]+5,x[0][1])]),
